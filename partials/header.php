        ...
        <div class="container">
            <div class="row-fluid">
                <div class="col-md-6 col-sm-6 text-left">
                    <p>
                        <strong><i class="fa fa-phone"></i></strong> +225 43 39 98 58 &nbsp;&nbsp;
                        <strong><i class="fa fa-phone"></i></strong> +225 05 54 55 64 &nbsp;&nbsp;
                        <strong><i class="fa fa-envelope"></i></strong> <a href="mailto:#">info@servira.ci</a>
                    </p>
                </div><!-- end left -->
        ...
        <nav class="navbar navbar-default yamm">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown yamm-fw yamm-half"><a href="#" data-toggle="dropdown" class="dropdown-toggle active">Notre Campus <b class="fa fa-angle-down"></b></a>
